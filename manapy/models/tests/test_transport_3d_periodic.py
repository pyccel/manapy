...
from manapy.fvm.pyccel_fvm import (explicitscheme_convective_3d,
...
dim = 3
readmesh(filename, dim=dim, periodic=[1,1,1])
...
ne = Variable(domain=domain, BC=boundaries, values=values)
